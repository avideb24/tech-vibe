            ...
            <div className="py-10 px-5">
                <div className=" max-w-xl mx-auto bg-[#132151]  p-10 rounded-md text-white">
                    ...
                    <form className="mt-10 text-blue-950" onSubmit={handleRegister}>
                        <input onChange={handleUserName} className="w-full border-2 border-white p-2 rounded-md" type="text" name="name" required placeholder="Enter your name" />
                        <input onChange={handleUserPhoto} className="w-full border-2 border-white p-2 rounded-md my-4" type="text" name="photo" required placeholder="Enter your photo URL" />
