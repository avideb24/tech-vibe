            ...
            <div className='absolute w-full h-full left-0 top-0  '>
                ...
                <div className='flex justify-end h-full items-center px-5 max-w-7xl mx-auto'>
                    <div className='xl:max-w-2xl md:px-0 sm:px-10 px-5 text-right space-y-6'>
                        ...
                        <p className='sm:pl-32 pl-0 md:text-md text-sm'>Dive And Experience Hands-on Workshops, Inspiring Talks, and the Future of Tech, All Under One Roof! Connect with Industry Leaders, Engage in Cutting-Edge Demos, and Shape the Future Together. Embrace the Tech Revolution – Your Gateway to Tomorrow Awaits!</p>
                    </div>
                </div>
            </div>
        </div>
